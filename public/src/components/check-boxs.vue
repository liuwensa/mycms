<template>
  <div class="border-wrapper">
    <div class="matched-list">
      <ul class="checkbox-inline" v-for="(item, index) in checkboxList">
        <li>
          <input type="checkbox" value="item.Name" v-model="item._checked" @change="check(item, $event.target.checked)"> {{ item[showKey] }}
        </li>
      </ul>
    </div>
  </div>

                ...
                <div class="direct-chat-msg" ng-repeat="msg in mainData.msgList">
                  <div ng-switch on="msg.utype">
                    <span ng-switch-when="0">
                      ...
                      <!--<a href="#">{{msg.author.userName}}</a>在 《-->
                      <!--<a href="/details/{{msg.contentId}}.html" target="_blank" ng-bind="msg.contentTitle"></a>》 中说-->
                      <!--</span>-->
                      <!--<span class="direct-chat-timestamp pull-right">-->
                      <!--<i class="fa fa-clock-o"></i> -->
                      <!--<span ng-bind="msg.date | date : 'yyyy-MM-dd HH:mm:ss'"></span>-->
                      <!--</span>-->
                      <!--</div>-->
                      <!--<img alt="message user image" ng-src="{{msg.author.logo}}" class="direct-chat-img">-->
                      <!--<div class="direct-chat-text" ng-bind="msg.content"></div>-->
                    </span>
                  </div>
                </div>
              </div>
